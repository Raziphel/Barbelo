...
class purgatory(Cog):
    ...
    async def rules(self):
        ...
        embed1=Embed(description=f"# 1. Chat Etiquette\n🐍 **All text & voice channels are english only.**  Staff must be able to understand anything being said on Esoterica.\n🐍 **No Harassment.** Racism, sexism, xenophobia, transphobia, misohyny, etc. are never allowed.\n🐍 **No Drama.** No matter how you feel about others you can't bring it up here.\n🐍 **No Politics, No Religion.**  Chats about Spirituality is allowed in *some* chats.\n🐍**No Spamming.**  Anything that can be seen as cluttering up a chat or repetitive in a VC.\n🐍 **No Self Promotion.** Unless done so in a channel deciated to self promotion.\n", color=0xff0000)
