...
class store_Handler(Cog):
    ...
    async def store_msg(self):
        ...
        embed4.add_field(name=f"⊰ 🌻 Sun Flower ⊱", value=f"**╰⊰ {self.bot.config['currency_emoji']['coin_emoji']}100,000x**\n\n<@&{self.bot.config['color_roles']['sun_flower']}>", inline=True)
        embed4.add_field(name=f"⊰ 🥗 Nephritis ⊱", value=f"**╰⊰ {self.bot.config['currency_emoji']['coin_emoji']}100,000x**\n\n<@&{self.bot.config['color_roles']['nephritis']}>", inline=True)
        embed4.add_field(name=f"⊰ 🧿 Belize Hole ⊱", value=f"**╰⊰ {self.bot.config['currency_emoji']['coin_emoji']}100,000x**\n\n<@&{self.bot.config['color_roles']['belize_hole']}>", inline=True)
        embed4.add_field(name=f"⊰ 🪀 Wisteria ⊱", value=f"**╰⊰ {self.bot.config['currency_emoji']['coin_emoji']}100,000x**\n\n<@&{self.bot.config['color_roles']['wisteria']}>", inline=True)
        embed4.add_field(name=f"⊰ ⛅ Clouds ⊱", value=f"**╰⊰ {self.bot.config['currency_emoji']['coin_emoji']}100,000x**\n\n<@&{self.bot.config['color_roles']['clouds']}>", inline=True)
        embed4.add_field(name=f"⊰ 🧩 Turquoise ⊱", value=f"**╰⊰ {self.bot.config['currency_emoji']['coin_emoji']}100,000x**\n\n<@&{self.bot.config['color_roles']['turquoise']}>", inline=True)

        embed4.add_field(name=f"⊰ 🍑 Pastel Pink ⊱", value=f"**╰⊰ {self.bot.config['currency_emoji']['coin_emoji']}200,000x**\n\n<@&{self.bot.config['color_roles']['pastel_pink']}>", inline=True)
        embed4.add_field(name=f"⊰ 🍇 Pastel Violet ⊱", value=f"**╰⊰ {self.bot.config['currency_emoji']['coin_emoji']}200,000x**\n\n<@&{self.bot.config['color_roles']['pastel_violet']}>", inline=True)
        embed4.add_field(name=f"⊰ 🧊 Pastel Blue ⊱", value=f"**╰⊰ {self.bot.config['currency_emoji']['coin_emoji']}200,000x**\n\n<@&{self.bot.config['color_roles']['pastel_blue']}>", inline=True)
        embed4.add_field(name=f"⊰ 🥒 Pastel Green ⊱", value=f"**╰⊰ {self.bot.config['currency_emoji']['coin_emoji']}200,000x**\n\n<@&{self.bot.config['color_roles']['pastel_green']}>", inline=True)
        embed4.add_field(name=f"⊰ 🍋 Pastel Yellow ⊱", value=f"**╰⊰ {self.bot.config['currency_emoji']['coin_emoji']}200,000x**\n\n<@&{self.bot.config['color_roles']['pastel_yellow']}>", inline=True)
        embed4.add_field(name=f"⊰ 🍓 Pastel Red ⊱", value=f"**╰⊰ {self.bot.config['currency_emoji']['coin_emoji']}200,000x**\n\n<@&{self.bot.config['color_roles']['pastel_red']}>", inline=True)
